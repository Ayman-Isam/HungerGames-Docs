...
id: en-us
title: EN_US
slug: /languages/en_us
---
```yaml
time-remaining: "Time remaining"
no-world: "&cPlease enter the name of the world to perform action!"
no-permission: "&cYou do not have permission to run this command"
no-server: "&cThis command can only be executed by players"
no-database: "&cThe plugin does not have a database enabled for stats tracking"
...
game:
  ...
  no-args: "&cUsage: /hg slot <action> <slotname> <worldname>"
  no-action: "&cInvalid action. Use create, remove or assign."
  no-slot: "&cSlot with name &6{0}&c doesn't exist"
  removed-slot: "&cRemoved slot with name &6{0}"
  created-slot: "&aCreated slot with name &6{0}&a and linked to world &6{1}"
  assigned-slot: "&bAssigned slot with name &6{0}&b to sign"
  slot-exists: "&cSlot with name &6{0}&c already exists"
  no-list: "&cCould not find any slots to list"
  auto-start: "&aMinimum players to automatically start game has been reached, starting game in &b{0} &aseconds"
  ...
  already-joined: "&cYou have already joined a game!"
  ...
  placed: "&bYou placed #{0}"

teleport:
  no-player: "&cPlease enter a player to teleport or all to teleport everyone!"
  invalid-player: "&cPlayer &b{0} &cnot found!"
  no-arena: "&cPlease enter an arena to teleport to!"
  invalid-world: "&cWorld &b{0} &cnot found!"
  teleported: "&bYou have been teleported to &d{0}"
  sender: "&d{0} &bhas been teleported to &d{1}"
...
startgame:
  ...
  start-s: "&eThe game will start in {0} seconds!"
  mid-s: "&e{0} seconds left!"
  end-s: "&c1 second left!"
  cancelled: "&cGame starting cancelled due to not enough players"

stats:
  player: "&dFetching stats for player &6{0}"
  header: "§6§l[ HungerGames Stats - §e{0}§6§l ]"
  separator: "§7 ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
  general-title: "§6§lGeneral Stats:"
  general-1: "§6• Games Started: §a{0} §6• Games Played: §a{1} §6• Games Won: §b{2}"
  general-2: "§6• Kills: §c{0} §6• Deaths: §c{1} §6• Kill Assists: §a{2} §6• K/D Ratio: §e{3}"
  general-3: "§6• Time Played: §e{0}h §6• Last Seen: §7{1}"
  solo-title: "§e§lSolo Stats:"
  solo-1: "§e• Solo Games Started: §a{0} §e• Solo Games Played: §a{1} §e• Solo Games Won: §b{2}"
  solo-2: "§e• Solo Percentile: §e{0}%"
  team-title: "§b§lTeam Stats:"
  team-1: "§b• Team Games Started: §a{0} §b• Team Games Played: §a{1} §b• Team Games Won: §b{2}"
  team-2: "§b• Team Percentile: §e{0}%"
  death-title: "§c§lDeath Stats:"
  death-1: "§c• Player Deaths: §c{0} §c• Environment Deaths: §c{1} §c• Border Deaths: §c{2}"
  death-2: "§c• Total Deaths: §c{0}"
  survival-title: "§e§lSurvival Stats:"
  survival-1: "§e• Chests Opened: §a{0} §e• Supply Drops Opened: §a{1}"
  survival-2: "§e• Potions Used: §a{0} §e• Food Consumed: §a{1}"
  survival-3: "§e• Totems Popped: §a{0} §e• Health Regenerated: §a{1}"
  combat-title: "§c§lCombat Stats:"
  combat-1: "§c• Arrows Shot: §a{0} §c• Arrows Landed: §a{1}"
  combat-2: "§c• Fireworks Shot: §a{0} §c• Fireworks Landed: §a{1}"
  combat-3: "§c• Attacks Blocked: §a{0}"
  combat-4: "§c• Damage Dealt: §a{0} §c• Projectile Damage Dealt: §a{1}"
  combat-5: "§c• Damage Taken: §a{0} §c• Projectile Damage Taken: §a{1}"
  footer: "§e▸ ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
team:
  ...
  close-inv: "&cClose"
  no-args: "&cUsage: /hg team <action> <team> <player>"
  no-action: "&cInvalid action. Use add, remove, list, finalize or reset"
  added: "&dPlayer &b{0} &dhas been added to team &e{1}."
  removed: "&dPlayer &b{0} &dhas been removed from team &e{1}."
  no-removed: "&cPlayer &d{0} &c does not exist in team &e{1}."
  reset: "&bPlayer teams have been reset"
  finalize: "&bPlayer teams have been finalized"
  already-finalize: "&cPlayer teams have already been finalized"
  no-finalize: "&cPlayer teams have not been finalized"
  no-player: "&cPlayer already in a team"
  no-list: "&cCould not find any teams to list"
  no-team: "&cYou haven't been assigned a team!"
